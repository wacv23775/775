...
class TSEdsbn(nn.Module):
    def __init__(self, layer4, branch, use_gpu=False):
        super(TSEdsbn, self).__init__()
        self.layer4 = layer4
        self.branch = branch
        self.block_size = 3
    ...
    def forward(self, x, domain_label):
        ...
        y0, _ = self.layer4(x0, domain_label)
        y0 = self.branch[0](y0, domain_label)
        ...
        y1,_ = self.layer4(x1, domain_label)
        y1 = self.branch[1](y1,domain_label)
